...
class SistemaNotificacoes {
    ...
    configurarBotoesTeste() {
        ...
        const testTelegramConn = document.getElementById('test-telegram');
        ...
        if (testBrowser) testBrowser.addEventListener('click', () => this.testarNotificacao('browser'));
        if (testTelegramConn) testTelegramConn.addEventListener('click', () => this.testarConexaoTelegram());
    }
