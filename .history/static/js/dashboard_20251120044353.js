...
async function atualizarDashboard() {
    try {
        ...
        // Atualizar componentes individuais
        atualizarDadosPZEM(data);
        atualizarKPIs(data);
        await atualizarGraficos(data); // Aguardar atualização dos gráficos
...
// Manter as outras funções (getElement, showToast, atualizarDadosPZEM, etc.) como estão
// ... [o resto do seu código JavaScript existente]
