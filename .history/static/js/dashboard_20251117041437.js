...
function gerarRelatorio() {
    ...
    if (reportPeriod === 'custom') {
        if (!startDate || !endDate) {
            showToast('Selecione a data inicial e a final', 'warning');
            return;
        }
        if (new Date(startDate) > new Date(endDate)) {
            showToast('Data inicial maior que data final', 'warning');
            return;
        }
    }
    ...
    fetch('/api/relatorio', {
        ...
        .then(data => {
            ...
            elements.reportResults.innerHTML = data.html; // <-- HTML pronto vindo do Flask
