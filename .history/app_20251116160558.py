...
def verificar_e_controlar_reles():
    """Desliga relés AUTOMÁTICOS quando saldo_global <= limite_individual"""
    config = Configuracao.query.first()
    if not config:
    ...
    print(f"🔋 SALDO GLOBAL: {saldo:.2f} kWh")
    ...
    for rele in reles:
        ...
        # 2️⃣ Não desligar relé recém alterado manualmente (proteção)
        ...
        # 3️⃣ Aplicar limite INDIVIDUAL em kWh
