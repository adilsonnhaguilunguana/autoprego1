...
def atualizar_reles_payload(data):
    ...
    for r_data in data['reles']:
        ...
        if rele:
            ...
            # ✅ VERIFICAÇÃO CRÍTICA: Se foi alterado manualmente recentemente, NÃO atualiza
            if (rele.ultima_alteracao_manual and 
                (datetime.utcnow() - rele.ultima_alteracao_manual).total_seconds() < 10):  # 10 segundos de proteção
