...
class Rele(db.Model):
    ...
    limite_individual = db.Column(db.Integer, default=500)
    saldo_minimo_para_desligar = db.Column(db.Float, default=1.0)  # kWh mínimo para desligar
    modo_automatico = db.Column(db.Boolean, default=True)  # ✅ CORRIGIDO: True=Automático, False=Manual
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    ...
    def to_dict(self):
        return {
            ...
            "modo_automatico": self.modo_automatico,  # ✅ CORRIGIDO
            "modo_desc": "Automático" if self.modo_automatico else "Manual",  # ✅ ADICIONADO
